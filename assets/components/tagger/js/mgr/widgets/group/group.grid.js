tagger.grid.Group = function(config) {
    ...
    Ext.applyIf(config,{
        ...
        save_action: 'Tagger\\Processors\\Group\\UpdateFromGrid',
        autosave: true,
...
Ext.extend(tagger.grid.Group,MODx.grid.Grid,{
    ...
    updateGroup: function(btn,e) {
        var updateGroup = MODx.load({
            ...
            action: 'Tagger\\Processors\\Group\\Update',
    ...
    removeGroup: function(btn,e) {
        ...
        MODx.msg.confirm({
            ...
            url: this.config.url,
            params: {
                action: 'Tagger\\Processors\\Group\\Remove',
            ...
            listeners: {
                ...
                afterrowmove: function(objThis, oldIndex, newIndex, records) {
                    MODx.Ajax.request({
                        url: MODx.config.connector_url,
                        params: {
                            action: 'Tagger\\Processors\\Group\\DDReorder',
