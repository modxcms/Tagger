Tagger.grid.Group = function(config) {
    ...
    Ext.applyIf(config,{
        ...
        ,autosave: true
        ,fields: ['id', 'name', 'alias', 'field_type', 'remove_unused', 'allow_new', 'allow_blank', 'allow_type', 'show_autotag', 'hide_input', 'tag_limit', 'show_for_templates', 'position', 'place', 'description', 'in_tvs_position', 'as_radio', 'sort_field', 'sort_dir']
        ,autoHeight: true
        ,paging: true
        ,remoteSort: true
